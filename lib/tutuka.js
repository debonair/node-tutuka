...
Tutuka.prototype.checksum = function(method, profileNumber, cardNumber, transactionId, transactionDate){
  console.log(this.terminalID + ', ' + profileNumber + ', ' + cardNumber + ', ' + transactionId + ', ' + transactionDate);
  ...
  return Q.Promise(function(resolve, reject, notify) {
    this.xmlrpc.methodCall(method, arguments, function(err, value){
      if(err){
        ...
        //console.log('Method response for ' + method + ' : ' + value.resultCode + ': ' + value.resultText);
      }
    });
  });
}
